...
export const deleteUser = (token, id) => request(`/admin/users/${id}/`, { method: 'DELETE', headers: authHeaders(token) });
...
export const deleteAdminTest = (token, id) => request(`/admin/tests/${id}/`, { method: 'DELETE', headers: authHeaders(token) });
...
export const deleteQuestion = (token, id) => request(`/admin/questions/${id}/`, { method: 'DELETE', headers: authHeaders(token) });
...
export const deleteOption = (token, id) => request(`/admin/options/${id}/`, { method: 'DELETE', headers: authHeaders(token) });
